...
class CategoryAcceptCondition extends AbstractCondition
{
	/**
	 * 
	 * {@inheritDoc}
	...
	public function matchCondition(array $conditionParameters)
	{
		if ($GLOBALS['TSFE']->fe_user)
		{
		    ...
		    {
		        return is_array($data) && array_key_exists('decision', $data) && $data['decision'] == 'agreed' && in_array($conditionParameters[0], $data['categorySettingsKey']);
		    }
		}
